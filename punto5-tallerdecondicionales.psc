...
Proceso DrogueriaApp
	...
	Segun opcion1 Hacer
		1:
			...
			Segun opcion2 Hacer
				1:
					nombrecompleto<-captura("tu nombre completo.");
					documento<-captura1("tu numero de documento sin puntos ni comas.");
					celular<-captura("tu numero de celular.");
					direccion<-captura("direccion donde llegarian los medicamentos");
