		...
		1: 
			...
			si opcion2 <= 5 Entonces
				si opcion2 <= 4 Entonces
					nombrecompleto<-captura("nombre completo");
					documento<-captura1("numero de documento sin puntos ni comas");
					celular<-captura1("numero de celular");
